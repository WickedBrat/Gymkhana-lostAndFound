 ...
 echo "<center>
	...
	<fieldset class='field-container'>
		...
		<table>	
			...
			<tr >
				<td colspan='10' align='center'><div  style='background:#722f37; width:70px; text-align:center; border:none; border-radius:5px;'><a style='color:white;' href='delete_found.php'>delete</a></div></td>
			</tr>
		</table>	
	</fieldset>
	</div>

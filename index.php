		     ...
		     $subject_found = $row_found['subject'];
		        ...
		        echo "<tr>
						<td class='table-item'><form method='POST' action='viewport_found.php'>
													...
													<input style='color:white; font-family:serif; background:none; border:none; font-size:20px; word-wrap: break-word;' type='submit' value='$subject_found'/>
							                   </form>
						</td>
					  </tr>";
		}
		     ...
		     #   //generate output
		        echo "<tr>
						<td class='table-item'><form method='POST' action='viewport_lost.php'>
													...
													<input style='color:white; font-family:serif; background:none; border:none; font-size:20px; word-wrap: break-word;' type='submit' value='$subject_lost'/>
							                   </form>
						</td>
					  </tr>";
	#	    }
